...
// ÄÄ Helpers ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
...
async function getLojaInfo(db) {
  ...
  return { nome: cfg.loja_nome || 'Loj√£o', email: cfg.loja_email || '' };
}
...
// ÄÄ GET /checkout ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
...
// ÄÄ POST /checkout ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
...
exports.processarCheckout = async (req, res) => {
  ...
  if (errosValidacao.length > 0) {
    ...
    console.warn('Valida√ß√£o de checkout falhou:', errosValidacao);
  ...
  console.log(`[Checkout] POST recebido Ä m√©todo: ${metodo_pagamento}, usu√°rio: ${usuarioId}`);

  // Verificar agenda antes de iniciar transa√ß√£o
  ...
  try {
    ...
    // Registrar agendamento (se m√≥dulo ativo)
    ...
    try {
      ...
      console.warn(' Erro ao verificar controle de estoque:', err.message);
      cfgEstoqueRes = { rows: [] };
    }
    ...
    // Cart√£o com 3DS: redireciona para p√°gina de autentica√ß√£o do Stripe
    ...
    console.error('\nÅÅÅ ERRO NO CHECKOUT ÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅ');
    ...
    console.error('ÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅÅ\n');
    res.redirect('/checkout?erro=pagamento');
  }
};

// ÄÄ GET /checkout/resultado/:id ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
...
// ÄÄ GET /meus-pedidos ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
...
// ÄÄ POST /webhook/stripe ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
...
// ÄÄ Admin: listar pedidos ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
...
// ÄÄ SumUp: webhook ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ
