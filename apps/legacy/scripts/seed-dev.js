 ...
 *
 * Uso:
 *   node scripts/seed-dev.js              # idempotente (upsert)
 *   node scripts/seed-dev.js --fresh        # remove dados [DEV] e recria
 *
 * Docker (stack no ar):
 *   docker compose exec legacy node scripts/seed-dev.js
 *   make seed
 *
 * Local (Postgres em localhost:5432):
 *   DATABASE_URL=postgresql://postgres:postgres@localhost:5432/lojao TENANT_SLUG=loja \
 *     node apps/legacy/scripts/seed-dev.js
 */
