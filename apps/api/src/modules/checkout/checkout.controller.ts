...
export async function getCheckoutPreviewHandler(
...
export async function postCheckout(request: FastifyRequest, reply: FastifyReply): Promise<void> {
...
export async function getCheckoutResultHandler(
  request: FastifyRequest,
  reply: FastifyReply,
): Promise<void> {
