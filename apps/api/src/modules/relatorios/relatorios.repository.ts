...
export async function findDadosVendas(db: pg.Pool, dataInicio: Date, dataFim: Date) {
...
export async function findDadosEstoque(db: pg.Pool, filtro: FiltroEstoque) {
  let filtroValido = filtro;
  if (!FILTROS_ESTOQUE.includes(filtroValido)) {
    filtroValido = 'todos';
  }
  const condicao = FILTROS_ESTOQUE_VALIDOS[filtroValido];
...
export async function findDadosEntregas(db: pg.Pool) {
...
export async function findDadosProdutos(db: pg.Pool, dataInicio: Date, dataFim: Date) {
...
export async function findDadosFinanceiro(db: pg.Pool, dataInicio: Date, dataFim: Date) {
...
export async function findDadosClientes(db: pg.Pool, dataInicio: Date, dataFim: Date) {
...
export async function findDadosAgendamentos(db: pg.Pool, dataInicio: Date, dataFim: Date) {
  try {
